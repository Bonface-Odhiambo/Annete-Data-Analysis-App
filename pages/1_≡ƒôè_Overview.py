...
with col_c:
    ...
    fig3.update_layout(barmode="stack", **PLOTLY_LAYOUT, height=240, showlegend=True,
                       yaxis=dict(range=[0,100], gridcolor=BORDER, ticksuffix="%", color=MUTED, linecolor=BORDER),
                       xaxis=dict(gridcolor="rgba(0,0,0,0)", color=MUTED, linecolor=BORDER),
...
st.dataframe(summ, width='content')
