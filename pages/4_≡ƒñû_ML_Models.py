...
with c1:
    ...
    fig = go.Figure(go.Bar(
        ...
        marker_color=[hex_to_rgba(c, 0.73) for c in MODEL_COLORS],
...
with c2:
    ...
    fig2.add_trace(go.Bar(name="MAE", x=model_names,
        ...
        marker_color=[hex_to_rgba(c, 0.60) for c in MODEL_COLORS],
    ...
    fig2.add_trace(go.Bar(name="RMSE", x=model_names,
        ...
        marker_color=[hex_to_rgba(c, 0.27) for c in MODEL_COLORS],
        marker_line_color=MODEL_COLORS, marker_line_width=1.5))
